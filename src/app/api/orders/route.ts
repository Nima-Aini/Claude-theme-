...
async function ensureSchema() { const c=await pool.connect(); try { await c.query("ALTER TABLE orders ADD COLUMN IF NOT EXISTS customer_postal_code VARCHAR(10);"); } finally { c.release(); } }
