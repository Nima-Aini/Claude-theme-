...
export const orders = pgTable("orders", {
  ...
  commissionQuoteAmount: integer("commission_quote_amount").notNull().default(0),
  paymentMethod: varchar("payment_method", { length: 30 }).notNull().default("legacy"),
  paymentStatus: varchar("payment_status", { length: 30 }).notNull().default("legacy"),
  paymentAuthority: varchar("payment_authority", { length: 100 }),
  paymentRefId: varchar("payment_ref_id", { length: 100 }),
  paidAt: timestamp("paid_at"),
  paymentExpiresAt: timestamp("payment_expires_at"),
  reservationActive: boolean("reservation_active").notNull().default(false),
...
// Customer logins/visits by shop
export const customerShopLogins = pgTable("customer_shop_logins", {
  id: serial("id").primaryKey(),
  customerId: integer("customer_id").notNull(),
  shopId: integer("shop_id").notNull(),
  createdAt: timestamp("created_at").defaultNow(),
